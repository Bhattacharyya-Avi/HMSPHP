...
if(isset($_GET['cancel']))
		  {
				  ...
				  header("location:http://localhost/hms/hms/appointment-history.php");
		  }
?>
<!DOCTYPE html>
<html lang="en">
...
?>
											...
											<tr>
												...
												<?php
$sql2=mysqli_query($con,"SELECT * FROM `doctorspecilization` Where id ='".$row['doctorSpecialization']."'");
while($row2=mysqli_fetch_array($sql2))
{
?>
							<td><?php echo $row2['specilization'];?></td>
												<?php } ?>
		...
		if(($row['userStatus']==1) && ($row['doctorStatus']==1)){ ?>
				...
				<?php } else if(($row['userStatus']==0) && ($row['doctorStatus']==1)) {?>
							Not Active
							<?php } } else echo "You have no control " ;?>
												</div>
