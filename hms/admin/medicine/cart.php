<?php
	session_start();//start sesson 3
	include_once('DB.php'); 
	$con=getCon();

	$user=$_SESSION['user_phn'];
	$user_phone = $user;
	$total=0;
...
<html lang="en">
	<head>
		<title>Admin | Medicine Cart</title>
		<meta charset="utf-8" />
...
<?php
		...
		$sql=mysqli_query($con,"SELECT * FROM `cart` where customer_phn='$user' ");
	...
	?>    
			...
			<tr>
				...
				<td><?php echo $row['medi_quantity'];?></td>
				<td><?php echo $row['medi_price'];?></td>
			</tr>
...
<!-- final submittion -->
			        	...
			        	<form action="medicine_list.php"  class="form-inline"  method="POST">
						    <div class="form-group">
						      ...
						      <input class="btn btn-primary" type="submit" name="done_logout" value="Confirm Payment">
			...
			<div class="container" style="margin: 50px;">
			    <div class="row">
			        <div class="col-sm-12 col-md-10 col-md-offset-1">
			        		<a href="medicine_list.php"  class="btn btn-success" style="color:#fff!important;">Buy More </a></p>
							<a href="PDF2.php?user=<?php echo $user_phone ;?>"  class="btn btn-success" style="color:#fff!important;">Download PDF </a></p>
			         </div>
			    </div>     
			</div>
