...
$sql=mysqli_query($con,"SELECT doctors.id,doctors.doctorName,doctors.docEmail,doctors.creationDate,doctorspecilization.specilization
 FROM doctors INNER JOIN doctorspecilization ON doctors.specilization_id = doctorspecilization.id");
$cnt=1;
